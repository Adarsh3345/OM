    ...
    return (
        <div className="font-sans">
            <header className="relative text-center text-white p-10 md:p-16 flex flex-col items-center justify-center min-h-[90vh] bg-cover bg-center bg-no-repeat before:absolute before:inset-0 before:bg-gradient-to-r before:from-[#5318EB] before:to-[#AB6EF9] before:opacity-80">
                ...
                <div className="relative z-20 flex flex-col justify-center px-6 py-4 w-full max-w-md bg-white/10 backdrop-blur-md rounded-lg shadow-lg">
                    <h2 className="text-center text-2xl font-bold tracking-tight text-white">Sign up for an account</h2>

                    {message && (
                        <p className="text-center text-sm font-semibold text-white mt-2">{message}</p>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-6">
                        ...
                        <div >
                            <label className="block text-sm font-medium text-white">or</label>
                            <hr className="py-2"/>
